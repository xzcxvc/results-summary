           ...
           bg-gradient-to-b from-indigo-500 to-indigo-700 sm:w-full lg:w-1/2 relative xs:rounded-b-[40px] sm:rounded-b-[40px] lg:rounded-[20px] sm:py-6 "
            ...
            <div className="summary p-9 flex gap-5 flex-col lg:w-6/12 relative rounded-[20px]">
              ...
              <div className="flex flex-col gap-4">
                <div className="reaction flex justify-between bg-[#FEF6F5] border-x-2 border-x-red-300 xs:py-2 py-3 px-3 rounded-lg font-medium text-md">
                ...
                <div className="reaction flex justify-between bg-[#FEFBF2] border-x-2 border-x-yellow-400 xs:py-2 py-3 px-3 rounded-lg  font-medium text-md ">
                  <div className="flex gap-3 items-center">
                ...
                <div className="reaction flex justify-between bg-[#F2FAFA] border-x-2 border-x-green-300 xs:py-2 py-3 px-3 rounded-lg  font-medium text-md ">
                  <div className="flex gap-3 items-center">
                ...
                <div className="reaction flex justify-between bg-[#F3F2FD] border-x-2 border-x-indigo-300 xs:py-2 py-3 px-3 rounded-lg  font-medium text-md ">
                  <div className="flex gap-3 items-center">
